...
async function searchProduct(context, params, customQuery) {
  var _a2;
  const variables = {
    query: params.term,
    first: (_a2 = params.perPage) != null ? _a2 : 5,
...
`;
async function customerRecover(context, params) {
  const variables = {
    email: params.email
  };
  const response = await context.client.apolloClient.mutate({
    mutation: DEFAULT_MUTATION$1,
    variables
  });
  return response;
}
...
`;
async function customerCreate(context, params) {
  const variables = {
    input: params
  };
  const response = await context.client.apolloClient.mutate({
...
`;
async function availableFilters(context, params, customQuery) {
  const variables = {
    handle: params.handle
  };
  const { filters } = context.extendQuery(customQuery, {
    filters: {
      query: DEFAULT_QUERY,
      variables
    }
...
function mapFacetToProductFilter(filters) {
  function getPriceFilters() {
    if (!filters.min && !filters.max)
      return {};
    return {
      price: __spreadValues(__spreadValues({}, filters.min && { min: parseFloat(filters.min) }), filters.max && { max: parseFloat(filters.max) })
    };
  }
  return __spreadValues({}, getPriceFilters());
}
...
`;
async function getCollection(context, { categorySlug, itemsPerPage, filters }, customQuery) {
  const variables = {
    handle: categorySlug,
    first: itemsPerPage != null ? itemsPerPage : 5,
...
`;
async function getPage(context, params, customQuery) {
  var _a2;
  const variables = __spreadValues(__spreadValues({}, params.handle && { handle: params.handle }), params.id && { id: params.id });
  ...
  return (_a2 = await context.client.apolloClient.query({
    query: page.query,
...
`;
async function getBlogs(context, params, customQuery) {
  var _a2, _b, _c;
  const variables = __spreadValues({
    first: 5
  }, params);
  ...
  return __spreadProps(__spreadValues({}, response), {
    data: __spreadProps(__spreadValues({}, response == null ? void 0 : response.data), {
      blogs: (_c = (_b = (_a2 = response == null ? void 0 : response.data) == null ? void 0 : _a2.blogs) == null ? void 0 : _b.edges) == null ? void 0 : _c.map((edge) => {
        var _a3, _b2, _c2;
        return __spreadProps(__spreadValues({}, edge == null ? void 0 : edge.node), {
          link: `${(_b2 = (_a3 = context.config) == null ? void 0 : _a3.cms) == null ? void 0 : _b2.blogs}/${(_c2 = edge == null ? void 0 : edge.node) == null ? void 0 : _c2.handle}`
        });
      })
    })
  });
...
`;
async function getBlog(context, params, customQuery) {
  const { blog } = context.extendQuery(customQuery, {
    blog: {
      query: GetBlogQuery,
      variables: params
    }
...
async function getArticles(context, params, customQuery) {
  var _a2, _b, _c, _d, _e;
...
`;
  ...
  return __spreadProps(__spreadValues({}, response), {
    pageInfo: (_b = (_a2 = response == null ? void 0 : response.data) == null ? void 0 : _a2.articles) == null ? void 0 : _b.pageInfo,
    data: __spreadProps(__spreadValues({}, response == null ? void 0 : response.data), {
      articles: (_e = (_d = (_c = response == null ? void 0 : response.data) == null ? void 0 : _c.articles) == null ? void 0 : _d.edges) == null ? void 0 : _e.map((edge) => {
        var _a3, _b2, _c2, _d2, _e2;
        return __spreadProps(__spreadValues({}, edge == null ? void 0 : edge.node), {
          link: `${(_b2 = (_a3 = context.config) == null ? void 0 : _a3.cms) == null ? void 0 : _b2.blogs}/${(_d2 = (_c2 = edge == null ? void 0 : edge.node) == null ? void 0 : _c2.blog) == null ? void 0 : _d2.handle}/${(_e2 = edge == null ? void 0 : edge.node) == null ? void 0 : _e2.handle}`,
          cursor: edge == null ? void 0 : edge.cursor
        });
      })
    })
  });
}
async function getArticle(context, params, customQuery) {
  var _a2, _b, _c;
...
`;
  const { article } = context.extendQuery(customQuery, {
    article: {
      query: articleQuery,
      variables: params
    }
  ...
  const node = (_a2 = response == null ? void 0 : response.data) == null ? void 0 : _a2.node;
  return __spreadProps(__spreadValues({}, response), {
    data: __spreadProps(__spreadValues({}, response == null ? void 0 : response.data), {
      article: __spreadProps(__spreadValues({}, node), {
        fullAuthorName: (_c = (_b = node == null ? void 0 : node.authorV2) == null ? void 0 : _b.name) != null ? _c : ""
      })
    })
  });
}
async function availableCountries(context, customQuery) {
  var _a2, _b, _c;
...
`;
  const { availableCountries: availableCountries2 } = context.extendQuery(customQuery, {
    availableCountries: {
  ...
  const response = await context.client.apolloClient.query({
    query: availableCountries2.query
  });
  return (_c = (_b = (_a2 = response == null ? void 0 : response.data) == null ? void 0 : _a2.localization) == null ? void 0 : _b.availableCountries) != null ? _c : [];
}
const apis = {
  searchProduct,
  customerRecover,
...
function getShopifyApolloAPIs() {
  return apis;
}
function createShopifyApollo(settings) {
  const client = new ApolloClient({
...
export { createShopifyApollo, getShopifyApolloAPIs };
