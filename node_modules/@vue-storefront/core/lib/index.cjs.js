...
exports.onSSR = compositionApi.onServerPrefetch;
exports.vsfRef = compositionApi.ref;
var configureSSR = function (config) {
    exports.onSSR = config.onSSR || exports.onSSR;
    exports.vsfRef = config.vsfRef || exports.vsfRef;
};

function sharedRef(value, key) {
    var $sharedRefsMap = exports.useVSFContext().$sharedRefsMap;
    var givenKey = key || value;
    if ($sharedRefsMap.has(givenKey)) {
        return $sharedRefsMap.get(givenKey);
    }
    var newRef = exports.vsfRef(key ? value : null, givenKey);
    $sharedRefsMap.set(givenKey, newRef);
    return newRef;
}

function wrap(element) {
    return compositionApi.isRef(element) ? element : compositionApi.ref(element);
}
...
var registerLogger = function (loggerImplementation, verbosity) {
    if (typeof loggerImplementation === 'function') {
        exports.Logger = loggerImplementation(verbosity);
        return;
    }
    switch (verbosity) {
        case 'info':
            exports.Logger = __assign(__assign(__assign({}, defaultLogger), loggerImplementation), { debug: function () { } });
            break;
        case 'warn':
            exports.Logger = __assign(__assign(__assign({}, defaultLogger), loggerImplementation), { info: function () { }, debug: function () { } });
            break;
        case 'error':
            exports.Logger = __assign(__assign(__assign({}, defaultLogger), loggerImplementation), { info: function () { }, warn: function () { }, debug: function () { } });
            break;
        case 'none':
            exports.Logger = {
                debug: function () { },
            ...
            break;
        default:
            exports.Logger = __assign(__assign({}, defaultLogger), loggerImplementation);
    }
};
...
function addBasePath(path) {
    ...
    var basePath = (compositionApi.useRouter().options.base).slice(0, -1);
...
exports.useVSFContext = function () { return ({}); };
var configureContext = function (config) {
    exports.useVSFContext = config.useVSFContext || exports.useVSFContext;
};
var generateContext = function (factoryParams) {
    var vsfContext = exports.useVSFContext();
...
var getBaseUrl = function (req, basePath) {
    ...
    var isHttps = require('is-https')(req);
...
var getIntegrationConfig = function (context, configuration) {
    ...
    var initialConfig = merge({
        axios: {
            ...
            headers: __assign({}, (cookie ? { cookie: cookie } : {}))
        }
    }, configuration);
...
var integrationPlugin = function (pluginFn) { return function (nuxtCtx, inject) {
    var configure = function (tag, configuration) {
        ...
        var _a = nuxtCtx.$config, middlewareUrl = _a.middlewareUrl, ssrMiddlewareUrl = _a.ssrMiddlewareUrl;
        if (middlewareUrl) {
            config.axios.baseURL = process.server ? ssrMiddlewareUrl || middlewareUrl : middlewareUrl;
        }
        var client = axios__default["default"].create(config.axios);
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                ...
                exports.Logger.error("api.".concat(functionObject.fnName), err_1);
                return [3 /*break*/, 5];
            case 4:
                loading.value = false;
                return [7 /*endfinally*/];
...
var i18nRedirectsUtil = function (_a) {
    var path = _a.path, defaultLocale = _a.defaultLocale, availableLocales = _a.availableLocales, cookieLocale = _a.cookieLocale, acceptedLanguages = _a.acceptedLanguages;
    var arrayFromPath = path.split('/').filter(String);
    var localeCandidate = arrayFromPath[0];
    var isLocaleAvailable = function (locale) { return availableLocales.includes(locale); };
    ...
    var getTargetLocale = function () {
        var languagesOrderedByPriority = __spreadArray(__spreadArray([
            localeFromPath,
            cookieLocale
        ], acceptedLanguages, true), [
            defaultLocale
        ]);
        return languagesOrderedByPriority.find(function (code) { return isLocaleAvailable(code); });
    };
...
var apiClientFactory = function (factoryParams) {
    function createApiClient(config, customApi) {
        ...
        exports.Logger.debug('apiClientFactory.create', settings);
    ...
    return function useBilling() {
        ...
        var load = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            exports.Logger.debug('useBilling.load');
                            _d.label = 1;
                        case 1:
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useBilling/load', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var save = function (saveParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        exports.Logger.debug('useBilling.save');
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        ...
                        exports.Logger.error('useBilling/save', err_2);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        return {
            ...
            billing: compositionApi.computed(function () { return billing.value; }),
            loading: compositionApi.computed(function () { return loading.value; }),
            error: compositionApi.computed(function () { return error.value; }),
            load: load,
            save: save
        };
    };
...
var useCartFactory = function (factoryParams) {
    return function useCart() {
        ...
        var setCart = function (newCart) {
            cart.value = newCart;
            exports.Logger.debug('useCartFactory.setCart', newCart);
        };
        var addItem = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            exports.Logger.debug('useCart.addItem', { product: product, quantity: quantity });
                            _b.label = 1;
                        case 1:
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useCart/addItem', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var removeItem = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            exports.Logger.debug('useCart.removeItem', { product: product });
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useCart/removeItem', err_2);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var updateItemQty = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            exports.Logger.debug('useCart.updateItemQty', { product: product, quantity: quantity });
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useCart/updateItemQty', err_3);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var load = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            exports.Logger.debug('useCart.load');
                            if (cart.value) {
                                /**
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useCart/load', err_4);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var clear = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        exports.Logger.debug('useCart.clear');
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        ...
                        exports.Logger.error('useCart/clear', err_5);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        var applyCoupon = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            exports.Logger.debug('useCart.applyCoupon');
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useCart/applyCoupon', err_6);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var removeCoupon = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            exports.Logger.debug('useCart.removeCoupon');
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useCart/removeCoupon', err_7);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        return {
            api: _factoryParams.api,
            setCart: setCart,
            cart: compositionApi.computed(function () { return cart.value; }),
            isInCart: isInCart,
            addItem: addItem,
            load: load,
    ...
    return function useCategory(id) {
        ...
        var search = function (searchParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useCategory/".concat(id, "/search"), searchParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        ...
                        exports.Logger.error("useCategory/".concat(id, "/search"), err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        return {
            ...
            search: search,
            loading: compositionApi.computed(function () { return loading.value; }),
            categories: compositionApi.computed(function () { return categories.value; }),
            error: compositionApi.computed(function () { return error.value; })
        };
    };
}
    ...
    return function useContent(id) {
        ...
        var search = function (params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useContent/".concat(id, "/search"), params);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useContent/".concat(id, "/search"), err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        return {
            api: _factoryParams.api,
            search: search,
            content: compositionApi.computed(function () { return content.value; }),
            loading: compositionApi.computed(function () { return loading.value; }),
            error: compositionApi.computed(function () { return error.value; })
        };
    };
    ...
    var useFacet = function (id) {
        ...
        var search = function (params) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useFacet/".concat(ssrKey, "/search"), params);
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useFacet/".concat(ssrKey, "/search"), err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        return {
            result: compositionApi.computed(function () { return result.value; }),
            loading: compositionApi.computed(function () { return loading.value; }),
            error: compositionApi.computed(function () { return error.value; }),
            search: search
        };
        ...
        var make = function (params) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            exports.Logger.debug('useMakeOrder.make');
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useMakeOrder.make', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
    ...
    return function useProduct(id) {
        ...
        var search = function (searchParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useProduct/".concat(id, "/search"), searchParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useProduct/".concat(id, "/search"), err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        return {
            search: search,
            products: compositionApi.computed(function () { return products.value; }),
            loading: compositionApi.computed(function () { return loading.value; }),
            error: compositionApi.computed(function () { return error.value; })
        };
    };
    ...
    return function useReview(id) {
        ...
        var search = function (searchParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useReview/".concat(id, "/search"), searchParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useReview/".concat(id, "/search"), err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        var addReview = function (params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useReview/".concat(id, "/addReview"), params);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        ...
                        exports.Logger.error("useReview/".concat(id, "/addReview"), err_2);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        return {
            ...
            search: search,
            addReview: addReview,
            reviews: compositionApi.computed(function () { return reviews.value; }),
            loading: compositionApi.computed(function () { return loading.value; }),
            error: compositionApi.computed(function () { return error.value; })
        };
    };
    ...
    return function useShipping() {
        ...
        var load = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            exports.Logger.debug('useShipping.load');
                            _d.label = 1;
                        case 1:
                            _d.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            err_1 = _d.sent();
                            error.value.load = err_1;
                            exports.Logger.error('useShipping/load', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var save = function (saveParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        exports.Logger.debug('useShipping.save');
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_2 = _a.sent();
                        error.value.save = err_2;
                        exports.Logger.error('useShipping/save', err_2);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        return {
            api: _factoryParams.api,
            shipping: compositionApi.computed(function () { return shipping.value; }),
            loading: compositionApi.computed(function () { return loading.value; }),
            error: compositionApi.computed(function () { return error.value; }),
            load: load,
            save: save
...
var useUserBillingFactory = function (factoryParams) {
    var useUserBilling = function () {
        ...
        var _factoryParams = configureFactoryParams(factoryParams, { mainRef: billing, alias: 'currentBilling', loading: loading, error: error });
        var readonlyBilling = compositionApi.unref(billing);
        var addAddress = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserBilling.addAddress', address);
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useUserBilling/addAddress', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var deleteAddress = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserBilling.deleteAddress', address);
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useUserBilling/deleteAddress', err_2);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var updateAddress = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserBilling.updateAddress', address);
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useUserBilling/updateAddress', err_3);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var load = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug('useUserBilling.load');
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_4 = _b.sent();
                        error.value.load = err_4;
                        exports.Logger.error('useUserBilling/load', err_4);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        var setDefaultAddress = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserBilling.setDefaultAddress');
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useUserBilling/setDefaultAddress', err_5);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
...
var useUserFactory = function (factoryParams) {
    return function useUser() {
        ...
        var isAuthenticated = compositionApi.computed(function () { return Boolean(user.value); });
        ...
        var setUser = function (newUser) {
            user.value = newUser;
            exports.Logger.debug('useUserFactory.setUser', newUser);
        };
        ...
        var updateUser = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserFactory.updateUser', providedUser);
                            resetErrorValue();
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useUser/updateUser', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var register = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserFactory.register', providedUser);
                            resetErrorValue();
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useUser/register', err_2);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var login = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserFactory.login', providedUser);
                            resetErrorValue();
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useUser/login', err_3);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var logout = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        exports.Logger.debug('useUserFactory.logout');
                        resetErrorValue();
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        ...
                        exports.Logger.error('useUser/logout', err_4);
                        return [3 /*break*/, 4];
        ...
        var changePassword = function (params) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug('useUserFactory.changePassword', { currentPassword: mask(params.current), newPassword: mask(params.new) });
                        resetErrorValue();
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                    ...
                    case 3:
                        ...
                        exports.Logger.error('useUser/changePassword', err_5);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        var load = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            exports.Logger.debug('useUserFactory.load');
                            resetErrorValue();
                            _d.label = 1;
                        case 1:
                            _d.trys.push([1, 3, 4, 5]);
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useUser/load', err_6);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        return {
            api: _factoryParams.api,
            setUser: setUser,
            user: compositionApi.computed(function () { return user.value; }),
    ...
    return function useUserOrder() {
        ...
        var search = function (searchParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug('useUserOrder.search', searchParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error('useUserOrder/search', err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        return {
            api: _factoryParams.api,
            orders: compositionApi.computed(function () { return orders.value; }),
            search: search,
            loading: compositionApi.computed(function () { return loading.value; }),
            error: compositionApi.computed(function () { return error.value; })
        };
...
var useUserShippingFactory = function (factoryParams) {
    var useUserShipping = function () {
        ...
        var readonlyShipping = compositionApi.unref(shipping);
        var error = sharedRef({
            addAddress: null,
            deleteAddress: null,
            updateAddress: null,
        ...
        var addAddress = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserShipping.addAddress', mask(address));
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            err_1 = _c.sent();
                            error.value.addAddress = err_1;
                            exports.Logger.error('useUserShipping/addAddress', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var deleteAddress = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserShipping.deleteAddress', address);
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            err_2 = _c.sent();
                            error.value.deleteAddress = err_2;
                            exports.Logger.error('useUserShipping/deleteAddress', err_2);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var updateAddress = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserShipping.updateAddress', address);
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            err_3 = _c.sent();
                            error.value.updateAddress = err_3;
                            exports.Logger.error('useUserShipping/updateAddress', err_3);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var load = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug('useUserShipping.load');
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_4 = _b.sent();
                        error.value.load = err_4;
                        exports.Logger.error('useUserShipping/load', err_4);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        var setDefaultAddress = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useUserShipping.setDefaultAddress', address);
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            err_5 = _c.sent();
                            error.value.setDefaultAddress = err_5;
                            exports.Logger.error('useUserShipping/setDefaultAddress', err_5);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
...
var useWishlistFactory = function (factoryParams) {
    var useWishlist = function () {
        ...
        var setWishlist = function (newWishlist) {
            ...
            exports.Logger.debug('useWishlistFactory.setWishlist', newWishlist);
        };
        var addItem = function (_a) {
            var product = _a.product, customQuery = _a.customQuery;
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            exports.Logger.debug('useWishlist.addItem', product);
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            err_1 = _b.sent();
                            error.value.addItem = err_1;
                            exports.Logger.error('useWishlist/addItem', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var removeItem = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            exports.Logger.debug('useWishlist.removeItem', product);
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            err_2 = _b.sent();
                            error.value.removeItem = err_2;
                            exports.Logger.error('useWishlist/removeItem', err_2);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var load = function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            exports.Logger.debug('useWishlist.load');
                            if (wishlist.value)
                                return [2 /*return*/];
                            _d.label = 1;
                        case 1:
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useWishlist/load', err_3);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var clear = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        exports.Logger.debug('useWishlist.clear');
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        ...
                        exports.Logger.error('useWishlist/clear', err_4);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        var isInWishlist = function (_a) {
            var product = _a.product;
            exports.Logger.debug('useWishlist.isInWishlist', product);
        ...
        return {
            api: _factoryParams.api,
            wishlist: compositionApi.computed(function () { return wishlist.value; }),
...
var useShippingProviderFactory = function (factoryParams) {
    return function useShippingProvider() {
        ...
        var setState = function (newState) {
            ...
            exports.Logger.debug('useShippingProvider.setState', newState);
        };
        var save = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            exports.Logger.debug('useShippingProvider.save');
                            _d.label = 1;
                        case 1:
                            _d.trys.push([1, 3, 4, 5]);
                            loading.value = true;
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useShippingProvider/save', err_1);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
        ...
        var load = function (_a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            exports.Logger.debug('useShippingProvider.load');
                            _e.label = 1;
                        case 1:
                        ...
                        case 3:
                            ...
                            exports.Logger.error('useShippingProvider/load', err_2);
                            return [3 /*break*/, 5];
                        case 4:
                            loading.value = false;
                            return [7 /*endfinally*/];
    ...
    return function useForgotPassword() {
        ...
        var request = function (resetPasswordParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug('useForgotPassword/request', resetPasswordParams.email);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        ...
                        exports.Logger.error('useForgotPassword/request', err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
        ...
        var setNew = function (setNewPasswordParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug('useForgotPassword/setNew', setNewPasswordParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        ...
                        exports.Logger.error('useForgotPassword/setNew', err_2);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
...
function useStoreFactory(factoryParams) {
    return function useStore() {
        ...
        function load(params) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            exports.Logger.debug('useStoreFactory.load', params);
                            error.value.load = null;
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 3, 4, 5]);
        ...
        function change(params) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            exports.Logger.debug('useStoreFactory.change', params);
        ...
        return {
            load: load,
            change: change,
            response: compositionApi.computed(function () { return response.value; }),
            loading: compositionApi.computed(function () { return loading.value; }),
            error: compositionApi.computed(function () { return error.value; })
        };
    };
    ...
    return function useSearch(id) {
        ...
        var search = function (searchParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        exports.Logger.debug("useSearch/".concat(id, "/search"), searchParams);
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        loading.value = true;
                    ...
                    case 3:
                        err_1 = _b.sent();
                        error.value.search = err_1;
                        exports.Logger.error("useSearch/".concat(id, "/search"), err_1);
                        return [3 /*break*/, 5];
                    case 4:
                        loading.value = false;
                        return [7 /*endfinally*/];
...
exports.AgnosticOrderStatus = void 0;
...
})(exports.AgnosticOrderStatus || (exports.AgnosticOrderStatus = {}));
...
exports.VSF_CHANNEL_COOKIE = VSF_CHANNEL_COOKIE;
exports.VSF_COUNTRY_COOKIE = VSF_COUNTRY_COOKIE;
exports.VSF_CURRENCY_COOKIE = VSF_CURRENCY_COOKIE;
exports.VSF_LOCALE_COOKIE = VSF_LOCALE_COOKIE;
exports.VSF_STORE_COOKIE = VSF_STORE_COOKIE;
exports.addBasePath = addBasePath;
exports.apiClientFactory = apiClientFactory;
exports.configureContext = configureContext;
exports.configureFactoryParams = configureFactoryParams;
exports.configureSSR = configureSSR;
exports.generateContext = generateContext;
exports.i18nRedirectsUtil = i18nRedirectsUtil;
exports.integrationPlugin = integrationPlugin;
exports.mask = mask;
exports.registerLogger = registerLogger;
exports.renderContentFactory = renderContentFactory;
exports.sharedRef = sharedRef;
exports.track = track;
exports.useBillingFactory = useBillingFactory;
exports.useCartFactory = useCartFactory;
exports.useCategoryFactory = useCategoryFactory;
exports.useContentFactory = useContentFactory;
exports.useFacetFactory = useFacetFactory;
exports.useForgotPasswordFactory = useForgotPasswordFactory;
exports.useMakeOrderFactory = useMakeOrderFactory;
exports.useProductFactory = useProductFactory;
exports.useReviewFactory = useReviewFactory;
exports.useSearchFactory = useSearchFactory;
exports.useShippingFactory = useShippingFactory;
exports.useShippingProviderFactory = useShippingProviderFactory;
exports.useStoreFactory = useStoreFactory;
exports.useUserBillingFactory = useUserBillingFactory;
exports.useUserFactory = useUserFactory;
exports.useUserOrderFactory = useUserOrderFactory;
exports.useUserShippingFactory = useUserShippingFactory;
exports.useWishlistFactory = useWishlistFactory;
exports.wrap = wrap;
